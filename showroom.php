...
$('.lightbox').littleLightBox();
      ...
      <div class="col-md-3 smmob">
        <div class="projecthomeout">
          ...
          <div class="projimg"><img src="images/project/showroom/1.jpg"></div>
          </a>
        </div>
      </div>
      ...
      <div class="col-md-3 smmob">
        <div class="projecthomeout">
          <a class="lightbox thumbnail attractions-gallery" data-littlelightbox-group="gallery" >
          <div class="projimg"><img src="images/project/showroom/2.jpg"></div>
          </a>
        </div>
      </div>
      ...
      <div class="col-md-3 smmob">
        <div class="projecthomeout">
          <a class="lightbox thumbnail attractions-gallery" data-littlelightbox-group="gallery" >
          <div class="projimg"><img src="images/project/showroom/3.jpg"></div>
          </a>
        </div>
      </div>
      ...
      <div class="col-md-3 smmob">
        <div class="projecthomeout">
          <a class="lightbox thumbnail attractions-gallery" data-littlelightbox-group="gallery" >
          <div class="projimg"><img src="images/project/showroom/4.jpg"></div>
          </a>
        </div>
      </div>
