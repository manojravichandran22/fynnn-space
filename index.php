...
<p>Your space deserves the best and we make sure you get it.<p>
...
<p>Your space deserves outstanding detail and we deliver with precision.<p>
...
<section class="homewelsection">
  ...
  <div class="welcompartout">
      ...
      <div class="welpart1"><img src="images/homeicon/1.png" />
          <div class="welpartcon"><h3><span class="counter">25</span>K +</h3><h6>Interior Design</h6></div>
          </div>

          
      <div class="welpart1"><img src="images/homeicon/2.png" />
          <div class="welpartcon"><h3><span class="counter">100</span> +</h3><h6>Design Experts</h6></div>
          </div>

          
      <div class="welpart1"><img src="images/homeicon/3.png" />
          <div class="welpartcon"><h3><span class="counter">17</span>K +</h3><h6>Design Options</h6></div>
          </div>

          
      <div class="welpart1"><img src="images/homeicon/4.png" />
          <div class="welpartcon"><h3><span class="counter">03</span> +</h3><h6>Experiences</h6></div>
      </div>
...
<h6> Our Process</h6><h3 style="text-transform: uppercase;">How We Work</h3>
        </div>
