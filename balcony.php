...
$('.lightbox').littleLightBox();
      ...
      <div class="col-md-3 smmob">
        <div class="projecthomeout">
          ...
          <div class="projimg"><img src="images/project/balcony/1.jpg"></div>
          </a>
        </div>
      </div>
        ...
        <div class="projecthomeout">
          <a class="lightbox thumbnail attractions-gallery" data-littlelightbox-group="gallery" >
          <div class="projimg"><img src="images/project/balcony/2.jpg"></div>
          </a>
        </div>
      </div>
        ...
        <div class="projecthomeout">
          <a class="lightbox thumbnail attractions-gallery" data-littlelightbox-group="gallery" >
          <div class="projimg"><img src="images/project/balcony/3.jpg"></div>
          </a>
        </div>
      </div>
        ...
        <div class="projecthomeout">
          <a class="lightbox thumbnail attractions-gallery" data-littlelightbox-group="gallery" >
          <div class="projimg"><img src="images/project/balcony/4.jpg"></div>
          </a>
        </div>
      </div>
